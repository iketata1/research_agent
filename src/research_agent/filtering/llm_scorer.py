...
SYSTEM_PROMPT = (
    ...
    "Note bas (0-30) la simple veille technologique (nouveaux capteurs, produits), "
    "la recherche academique, et tout ce qui n'indique pas un client a demarcher. "
    "Les capteurs sont un produit futur : ils ne sont PAS la priorite. "
